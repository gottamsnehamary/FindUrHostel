		...
		if(s.equalsIgnoreCase("single"))
		{
			for(int i=0;i<10;i++)
			{
				if(single[i]==0)
				{
					single[i]=1;
					index=i;
					Booking book=new Booking(hostel.getName(),hostel.getMobile(),"VivantaGirls Hostel",i,15000,date);
					System.out.println("\n");
		...
		if(s.equalsIgnoreCase("two"))
		{
			for(int i=0;i<10;i++)
			{
				if(two[i]==0)
				{
					two[i]=1;
					index=i;
					Booking book=new Booking(hostel.getName(),hostel.getMobile(),"VivantaGirls Hostel",i,10000,date);
					System.out.println("\n");
					System.out.println("SUCESSFULLY BOOKED YOUR ROOM NUMBER IS "+i);
					book.success(book);
		...
		if(s.equalsIgnoreCase("three"))
		{
			for(int i=0;i<10;i++)
			{
				if(three[i]==0)
				{
					three[i]=1;
					index=i;
					Booking book=new Booking(hostel.getName(),hostel.getMobile(),"VivantaGirls Hostel",i,7000,date);
					System.out.println("\n");
					System.out.println("SUCESSFULLY BOOKED YOUR ROOM NUMBER IS "+i);
					book.success(book);
					list.add(book);	
